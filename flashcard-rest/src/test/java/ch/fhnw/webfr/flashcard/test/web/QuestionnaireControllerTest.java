...
public class QuestionnaireControllerTest {
    ...
    public void findById_QuestionnaireFound_ShouldReturnFound() throws Exception {
		...
		when(questionnaireRepositoryMock.findOne("1")).thenReturn(questionnaire);
	    ...
	    Mockito.verify(questionnaireRepositoryMock, times(1)).findOne("1");
    }
    ...
    public void findById_QuestionnaireNotExisting_ShouldReturnNotFound() throws Exception {	
	    ...
	    Mockito.verify(questionnaireRepositoryMock, times(0)).findOne("1");
    }	
	...
	public void update_questionnaire_ShouldReturnOK() throws Exception {
		...
		when(questionnaireRepositoryMock.findOne("1")).thenReturn(updatedQuestionnaire);
	...
	public void delete_questionnaire_ShouldReturnOK() throws Exception {
	    ...
	    Mockito.verify(questionnaireRepositoryMock, times(1)).delete("1");
	}
